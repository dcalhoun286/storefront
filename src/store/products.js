// initial state is going to be arr products
...
const initialState = {
  products: [
    ...
    },
    {
      ...
      "price": 850.99,
      "__v": 0,
      "description": "https://www.mobihall.com/data/news/2021/02/9d9c69d13f-img.jpg! Mate X2 is not the foldable for the masses that many of us desire. Instead, it is still very much a halo device, meant to impress and showcase more than anything else. In fact, it might just be even more unattainable than its predecessors, seeing how it is currently only sold in China, with no official intention of expanding availability and that the still ongoing US sanctions mean no Google Play Services and severely handcapped chipset manufacturing capabilities. And this is all before we even start to consider the Mate X2's eye-watering price tag of around EUR 2300."
    },
    {
    ...
    },
    {
      ...
      "price": 29.99,
      "__v": 0,
      "description": "Cool React T-Shirt$https://m.media-amazon.com/images/I/A13usaonutL._CLa%7C2140%2C2000%7C71kevjBxElL.png%7C0%2C0%2C2140%2C2000%2B0.0%2C0.0%2C2140.0%2C2000.0_AC_UX425_.png"
    },
    {
      ...
      "price": 34.99,
      "__v": 0,
      "description": "The most wanted Shirt in our store$https://m.media-amazon.com/images/I/91IM87eeuCL._CLa%7C2140%2C2000%7CA1U08nTxXML.png%7C0%2C0%2C2140%2C2000%2B0.0%2C0.0%2C2140.0%2C2000.0_AC_SX425._SX._UX._SY._UY_.png"
    },
    {
      ...
      "price": 24.99,
      "__v": 0,
      "description": "This Shirt is only for the Java lovers$https://images.lookhuman.com/render/standard/Qe7zCXWNatsTXXuTN7zExIXcHMKImMbu/3600-red-z1-t-coders-run-on-java.jpg"
    },
    {
